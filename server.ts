...
import { orderHistory, allOrders, toggleDeliveryStatus, savedOrderById } from './routes/orderHistory'
...
function configureApp (app: ReturnType<typeof express>, seq: typeof sequelize) {
  ...
  app.get('/rest/order-history/:id', utils.asyncHandler(savedOrderById()))
